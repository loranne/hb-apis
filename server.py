...
# ticketmaster root URL
# https://app.ticketmaster.com/discovery/v2/events
# URL for all events in the US: https://app.ticketmaster.com/discovery/v2/events.json?countryCode=US&apikey={apikey}
# good example for query string
#event search: /discovery/v2/events
#method for event search: Method: GET
